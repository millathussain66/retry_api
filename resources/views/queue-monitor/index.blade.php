                        ...
                        <!-- <div class="bg-white rounded-xl shadow">
                            ...
                            >
                                <h2 class="text-lg font-semibold text-gray-900">
                                    ...
                                    >Failed Jobs
                                    <span
                                        class="ml-2 bg-red-100 text-red-800 text-xs font-semibold px-2 py-1 rounded-full"
                            ...
                            <div class="p-4 max-h-96 overflow-y-auto">
                                ...
                                >
                                    <i
                                        class="fas fa-check-circle text-3xl mb-2"
                                    ></i>
                                    <p>No failed jobs</p>
                                </div>
                                ...
                                <template
                                    ...
                                    :key="job.id"
                                >
                                    <div class="job-card job-failed mb-3">
                                        <div
                                        ...
                                        >
                                            <div class="flex-1">
                                                ...
                                                <p
                                                    ...
                                                    x-text="job.exception?.substring(0, 100) + '...'"
                                                ></p>
                                                <div
